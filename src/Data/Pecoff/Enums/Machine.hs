...
-- | The 'machine' field of the 'CoffHeader' has one of the following values
-- that specifies its CPU type. An image file can be run only on the specified
