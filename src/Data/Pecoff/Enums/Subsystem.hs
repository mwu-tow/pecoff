...
-- | The following values defined for the 'subsystem' field of the
-- 'OptionalHeader' determine which Windows subsystem (if any) is required to
-- run the image.
data Subsystem
...
instance MyEnum Subsystem where
    mapping = 
